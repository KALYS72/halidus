...
'---------------------------------------assert---------------------------------------'
# assert - выражение, которое вызывает AssertionError, если условие не верное

assert 5 == 5, 'первый ассурт не верен'
print('DONE 1') 

assert 5 != 5, 'второй ассурт не верен'
print('NOPE') # AssertionError